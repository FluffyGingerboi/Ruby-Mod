...
import ruby.fluffy.helpme.items_displayed.block.IPillowBlock;
...
public class ItemPillow extends AbstractDisplayEntity {
    ...
    public ItemStack getPickResult() {
        return new ItemStack(this.getItemMap().getOrDefault(this.getType(), (Item) DisplayItems.DISPLAY.get()));
    }
